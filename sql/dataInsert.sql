...
('1','Mi LLP',567678789,3,0,9336,'Dictum Ave',18,'Naperville','Illinois','16136','eu.tellus@Curabitursedtortor.org'),
('1','Id Magna Industries',567678789,2,0,7589,'Etiam St.',67,'Biloxi','Mississippi','31789','ornare@sociisnatoquepenatibus.ca'),
...
('1','Bibendum Fermentum Metus Consulting',567678789,4,0,1597,'Et Avenue',77,'Glendale','Arizona','86288','metus.In@Integervitae.co.uk'),
('2','Donec Porttitor Limited',567678789,1,0,9919,'Ut Street',30,'Lincoln','NE','36647','egestas.Fusce@elit.ca'),
('2','Duis A Ltd',567678789,1,0,2292,'Neque. St.',98,'West Valley City','Utah','72147','magna.nec@duinec.co.uk'),
('2','Elit Erat Vitae Consulting',567678789,5,0,1315,'Neque Av.',91,'Montgomery','AL','35959','eget.ipsum.Donec@elitpede.co.uk'),
('2','Magnis Dis Parturient Consulting',567678789,1,0,1494,'Pharetra Rd.',25,'Sandy','Utah','50384','egestas.a.scelerisque@Crasloremlorem.edu'),
('2','Ac Corp.',567678789,3,0,8741,'Lorem Ave',54,'Augusta','Maine','77315','sollicitudin@conguea.edu'),
('2','Donec Est Institute',567678789,3,0,8061,'Aliquet St.',55,'Hilo','Hawaii','19507','ornare.facilisis.eget@musAeneaneget.edu'),
('2','Hendrerit A Industries',567678789,4,0,2650,'Nunc. Street',8,'Baton Rouge','Louisiana','84237','Sed.auctor.odio@cubiliaCuraeDonec.com'),
('2','Ac LLP',567678789,3,0,5922,'Viverra. Rd.',78,'South Portland','Maine','75370','Sed.diam@iaculisaliquetdiam.co.uk'),
('3','Nibh Aliquam Ornare Institute',567678789,4,0,704,'Donec Rd.',24,'Chattanooga','TN','54109','varius@cursusin.edu'),
('3','Hendrerit Institute',567678789,4,0,528,'Magna Rd.',14,'Hilo','Hawaii','65640','elit@condimentumeget.ca'),
('3','Turpis Company',567678789,2,0,6725,'Vitae St.',29,'Reno','Nevada','94615','sagittis.lobortis@elementum.edu'),
('3','Eget Varius Corporation',567678789,2,0,804,'Donec Road',51,'Broken Arrow','Oklahoma','87524','mi@augue.com'),
('3','Purus Mauris A LLC',567678789,2,0,6194,'Convallis Avenue',12,'Davenport','IA','16732','Morbi.metus@interdumNuncsollicitudin.edu'),
('3','Arcu LLC',567678789,2,0,762,'Penatibus Street',65,'Great Falls','Montana','80189','suscipit.nonummy@Duis.org'),
...
('4','Ante Nunc Corp.',567678789,5,0,6905,'Phasellus Av.',21,'Sacramento','California','92111','nulla.In.tincidunt@Aeneangravida.edu'),
('4','Pede Et Risus Incorporated',567678789,1,0,841,'Magna. Road',1,'Shreveport','Louisiana','73563','tempus.non@magnaLoremipsum.org'),
...
('4','Vel Vulputate Eu Incorporated',567678789,1,0,686,'Id Rd.',53,'Colchester','Vermont','24724','Duis.ac.arcu@mi.com'),
...
('5','Nonummy Ultricies Ornare LLP',567678789,4,0,7255,'Sit Road',56,'Des Moines','Iowa','48029','sollicitudin.adipiscing@sollicitudincommodoipsum.co.uk'),
('5','Urna Convallis Erat Incorporated',567678789,2,0,431,'Cras Road',90,'North Las Vegas','Nevada','26059','volutpat.nunc.sit@aliquamarcuAliquam.org'),
('5','Id Corporation',567678789,3,0,8060,'Odio. Rd.',4,'Fort Worth','TX','50595','ac.risus@Ut.com'),
('5','Mauris Blandit Industries',567678789,2,0,816,'Nec St.',68,'Mobile','Alabama','35141','vitae.aliquet@consectetuer.org'),
('5','Duis A Company',567678789,3,0,8778,'Duis Rd.',93,'Hattiesburg','Mississippi','86185','vitae@blanditat.edu'),
